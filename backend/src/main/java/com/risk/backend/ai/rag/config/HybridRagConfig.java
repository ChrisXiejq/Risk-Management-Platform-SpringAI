package com.risk.backend.ai.rag.config;

import com.risk.backend.ai.rag.crag.CragDocumentRetriever;
import com.risk.backend.ai.rag.crag.LlmRetrievalQualityEvaluator;
import com.risk.backend.ai.rag.crag.RetrievalQualityEvaluator;
import com.risk.backend.ai.rag.document.RagDocumentCorpus;
import com.risk.backend.ai.rag.graphrag.LlmEntityExtractor;
import com.risk.backend.ai.rag.postretrieval.DocumentReranker;
import com.risk.backend.ai.rag.postretrieval.EmbeddingReranker;
import com.risk.backend.ai.rag.postretrieval.CohereReranker;
import com.risk.backend.ai.rag.preretrieval.ContextualQueryAugmenterFactory;
import com.risk.backend.ai.rag.graphrag.EntityDocumentIndex;
import com.risk.backend.ai.rag.graphrag.EntityExtractor;
import com.risk.backend.ai.rag.graphrag.GraphRAGDocumentRetriever;
import com.risk.backend.ai.rag.hyde.HyDEDocumentRetriever;
import com.risk.backend.ai.rag.preretrieval.LlmMultiQueryExpander;
import com.risk.backend.ai.rag.preretrieval.MultiQueryExpander;
import com.risk.backend.ai.rag.retrieval.BM25DocumentRetriever;
import com.risk.backend.ai.rag.retrieval.HybridDocumentRetriever;
import com.risk.backend.ai.rag.retrieval.MultiQueryDocumentRetriever;
import com.risk.backend.ai.rag.retrieval.TenantAwareDocumentRetriever;
import com.risk.backend.ai.rag.retrieval.TracingDocumentRetriever;
...
public class HybridRagConfig {
    ...
    public EntityExtractor entityExtractor(ChatModel chatModel) {
        return new LlmEntityExtractor(chatModel);
    }
