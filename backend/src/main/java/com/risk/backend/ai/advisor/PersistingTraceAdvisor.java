package com.risk.backend.ai.advisor;

import com.risk.backend.ai.audit.AgentTraceRecord;
import com.risk.backend.ai.audit.AgentTraceRepository;
 ...
 * 检索结果来自 {@link TracingDocumentRetriever} 写入的 {@link RetrievalTraceContext}。
 */
@Slf4j
