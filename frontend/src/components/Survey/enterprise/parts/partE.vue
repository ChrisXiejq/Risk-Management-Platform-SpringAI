    ...
    <el-card style="border-radius: 15px;width: 100%;">
        ...
        <el-dialog style="font-family: SimSun;width: 40vw;align-items: center;justify-content: center;" title="纪念品领取"
            ...
            <el-card style="gap: 6px;border: none;align-items: center;justify-content: center;display: flex;"
                ...
                <el-container style="margin-top: 2vh">
                    <el-text>邮编</el-text>
                    <el-input v-model="awardForm.postCode" style="width: 60%;margin-left: 2vw;"></el-input>
                </el-container>
                <el-container style="margin-top: 2vh">
                    <el-text>收货人地址</el-text>
                    <el-input v-model="awardForm.receiverName" style="width: 60%;margin-left: 2vw;"></el-input>
                </el-container>
                <el-container style="margin-top: 2vh">
                    <el-text>收货人电话</el-text>
                    <el-input v-model="awardForm.phoneNumber" style="width: 60%;margin-left: 2vw;"></el-input>
                </el-container>
            </el-card>
            <template #footer>
